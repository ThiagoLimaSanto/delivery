...
export function FilterModal() {
  ...
  return (
    <>
      <MainModalTemplate title='Filtros' handleClick={handleOpen} click={!open}>
        <div className='flex flex-col justify-center h-full w-full gap-8 flex-wrap'>
          <div className='flex justify-between items-center'>
            <p className='font-semibold text-lg w-full'>Categorias:</p>
            <Link
              to={'/cardapio'}
