            ...
            <div className='md:w-1/2 '>
              ...
              <div className='flex flex-col w-full justify-center'>
                  ...
                  <p className='text-[#858a8d]'>
                    <span className='text-[#6C757D] font-bold'>Carne Fresca</span> - 100% bovina selecionada <br />
                    <span className='text-[#6C757D] font-bold'>Entrega Rápida</span> - Máximo 40 minutos <br />
                    <span className='text-[#6C757D] font-bold'>Pagamento Fácil</span> - PIX, cartão ou dinheiro <br />
                  </p>
              </div>
          </div>
        </div>
