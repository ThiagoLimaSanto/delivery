              ...
              <div className='my-8'>
                {active ? (
                  <>
                    <p>R. Caraiba, 106</p>
                    <p>
                      Rua abaixo do posto de saude sao francisco - Morrinhos/GO
                    </p>
                  </>
                ) : (
                  <>
              ...
              <div className='mt-6 flex flex-col gap-8'>
                {activePayment ? (
                  ...
                  <div className='flex gap-4 flex-wrap'>
                    <button className='px-3 py-2 hover:bg-[#D7ECDF]  border border-[#ccc] rounded-full cursor-pointer text-black'>Dinheiro</button>
                    <button className='px-3 py-2 hover:bg-[#D7ECDF]  border border-[#ccc] rounded-full cursor-pointer text-black'>Cartão Credito</button>
                    <button className='px-3 py-2 hover:bg-[#D7ECDF]  border border-[#ccc] rounded-full cursor-pointer text-black'> Cartão Debido</button>
                  </div>
                )}
              </div>
